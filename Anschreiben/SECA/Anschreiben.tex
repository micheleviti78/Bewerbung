...
\begin{letter}{seca services GmbH\\
Human Resources~\textbullet~Dina Jensen\\
Hammer Steindamm 3-25\\
22089 Hamburg}

\setkomavar{date}{\today}
\setkomavar{subject}{Bewerbung als Entwicklungsingenieur} 

\setlength{\parindent}{15pt}

\opening{Sehr geehrte Frau Jensen,} 

mein Name ist Michele Viti. Ich habe das Stellenangebot als
Entwicklungsingenieur mit gro{\ss}em Interesse gelesen und m{\"o}chte mich
darauf bewerben. \\
% W\"ahrend meiner
...
dieser Stellte als Entwicklungsingenieur. \"Uber eine Einladung zu
